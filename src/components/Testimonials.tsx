...
const REVIEWS = [
  {
    ...
    author: "Industrie-Kunde",
    service: "Online-Shop und Corporate Website",
  },
  {
    num: "02",
    ...
    author: "Dienstleistungsbetrieb",
    service: "Business-Webseite",
  },
  {
    num: "03",
    ...
    author: "Lokaler Gewerbekunde",
    service: "Erstberatung und Konzeption",
  },
  {
    num: "04",
    ...
    >
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-8 mb-16 pb-12 border-b border-[#121212]">
          <div>
            ...
            <h2 className="font-display font-extrabold text-[clamp(36px,5.5vw,72px)] uppercase tracking-[-0.035em] text-[#121212] leading-[0.98]">
              Fünf Sterne.
              <br />
              <span className="text-[#121212]/30">Volle Zufriedenheit.</span>
            </h2>
          </div>

          <p className="font-sans text-[16px] sm:text-[18px] text-[#121212]/75 max-w-md leading-relaxed font-normal">
            Echte Bewertungen von Betrieben, die direkt mit mir zusammengearbeitet haben. Keine anonymen Agenturschleifen, keine Stille Post. Sondern verbindliche Resultate.
          </p>
        </div>
        ...
        <motion.div
          ...
          className="bg-white border border-[#121212] rounded-[32px] p-8 sm:p-12 md:p-14 mb-8 shadow-xs"
        >
          ...
          <div className="pt-6 border-t border-[#121212]/15 flex flex-wrap items-center justify-between gap-4 font-mono text-xs">
            <div>
              ...
              <span className="text-[#121212]/50 text-[12px] ml-2">
                · {REVIEWS[0].service}
              </span>
            </div>
            <span className="text-[#121212]/60 text-[11px] uppercase tracking-wider font-semibold">
              ✓ Verifizierte Kundenrezension
            </span>
          </div>
        </motion.div>

        {/* Triptych Grid: Reviews 02, 03, 04 */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
          {REVIEWS.slice(1).map((review) => (
            <motion.div
              ...
              className="bg-white border border-[#121212] rounded-[28px] p-7 sm:p-8 flex flex-col justify-between hover:bg-[#fafaf8] transition-all duration-300 shadow-xs"
            >
              <div>
                {/* Header Bar */}
              ...
              <div className="pt-5 border-t border-[#121212]/15 font-mono text-xs">
                ...
                <div className="text-[#121212]/50 text-[11px] mt-0.5">
                  {review.service}
                </div>
              </div>
            </motion.div>
